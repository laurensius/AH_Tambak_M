...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("APP_BANDENG", 0);
        ...
        if(sf_username != null && sf_nama != null){
            Intent i = new Intent(Login.this,TambakBandeng.class);
            startActivity(i);
            finish();
        }
    ...
    void loginProcess(String username,String password){
        String tag_req_login = "BANDENG_LOGIN";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,getResources().getString(R.string.api_login), parameter,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Log.d("Bandeng Login :",response.toString());
                        pDialog.dismiss();
